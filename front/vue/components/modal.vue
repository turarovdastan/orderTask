        ...
        <div class="modal-content">
                ...
                <div>
                    <div class="description">
                        ...
                        <div class="price">{{mine.price}} ₽</div>
                        <div class="stars">
                    ...
                    <span>4,5</span>
                        ...
                        <div @click="addToBasket" class="btn-add"><span>Add to basket</span></div>
                        <div @click="$emit('close')" class="btn-close"><span>Close modal</span></div>
                    </div>
...
export default {
    props:['mine'],
    mounted(){
        this.$refs.mimg.setAttribute('src',`https://frontend-test.idaproject.com${this.mine.photo}`)
    },
    methods:{
        addToBasket(){
             this.$store.dispatch('fetchProduct',this.mine)
             this.$emit('close')
        }
    }
}
...
.modal-content{
    ...
    width: 90%;
    background: #fff;
    box-shadow: 4px 10px 56px rgba(0, 0, 0, 0.05);
    border-radius: 10px;
    display: flex;
