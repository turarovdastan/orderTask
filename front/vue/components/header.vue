...
<div @click="isModal =true" class="basket">
...
<span>{{countProductInBasket}}</span>
    ...
    <Basket v-if="isModal" @close="isModal=false"/>
</transition>
    </div>
</template>
